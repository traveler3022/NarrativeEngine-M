...
export function LoreTab() {
    ...
    const runIndex = async () => {
        ...
        try {
            ...
            const { saveLoreChunks } = await import('../../services/persistence/campaignStore');
    ...
    const persistBulk = (updated: LoreChunk[]) => {
        setLoreChunks(updated);
        if (activeCampaignId) {
            import('../../services/persistence/campaignStore').then(m => m.saveLoreChunks(activeCampaignId, updated));
        }
    };
