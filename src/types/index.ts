// Loot types hoisted to types/loot.ts — re-exported for backward compat.
export type {
    LootNodeId, LootPoolEntry, LootPool, LootPickNode,
    LootDrawSpec, LootDrawNode, LootAmountNode, LootComposeNode,
    LootNode, LootTree, LootProfile, LootItem,
    LootDropResult, ResolveLootOpts,
} from './loot';
