/**
 * @refactor RF-009
 * @violations 8 (see architecture/reverse-engineering/0.15-architecture-violations/RAW_DATA.json)
 * @waves W5
 * @ports (persistence service)
 * @godFile RF-009 (0 lines)
...
import { upgradeVectorOnlyDefault } from '../lore/loreIndexer';
import { affinityToPcRelation } from '../npc/agencyBands';
import { api } from '../apiClient';
import { migrateV1ToV2 } from '../campaign-state';
