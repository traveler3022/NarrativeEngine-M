...
import { loadChapters } from '../../persistence/campaignStore';
...
export async function handleSealChapter(state: TurnState, callbacks: TurnCallbacks, activeCampaignId: string): Promise<void> {
